 ...
 * @date 2019/1/10
 */
public class ProtoRequestEncoder extends MessageToByteEncoder<RpcMessage<RpcHeader.RequestHeader>>{
    @Override
    protected void encode(ChannelHandlerContext ctx, RpcMessage<RpcHeader.RequestHeader> msg, ByteBuf out) throws Exception {
